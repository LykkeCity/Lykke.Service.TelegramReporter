...
namespace Lykke.Service.TelegramReporter.Services.NettingEngine.Data
{
    public class Common
    {
        ...
        //public static SpreadViewModel GetSpreadDetails(IReadOnlyList<LimitOrderModel> traderLimitOrders, IReadOnlyList<LimitOrderModel> lykkeLimitOrders)
        //{
        //    traderLimitOrders = traderLimitOrders
        //        .Where(o => o.Error == LimitOrderError.None)
        //        .ToList();

        //    decimal minTraderAsk = traderLimitOrders
        //        .Where(o => o.Type == LimitOrderType.Sell)
        //        .Select(o => o.Price)
        //        .DefaultIfEmpty(0)
        //        .Min();

        //    decimal maxTraderBid = traderLimitOrders
        //        .Where(o => o.Type == LimitOrderType.Buy)
        //        .Select(o => o.Price)
        //        .DefaultIfEmpty(0)
        //        .Max();

        //    decimal maxTraderAsk = traderLimitOrders
        //        .Where(o => o.Type == LimitOrderType.Sell)
        //        .Select(o => o.Price)
        //        .DefaultIfEmpty(0)
        //        .Max();

        //    decimal minTraderBid = traderLimitOrders
        //        .Where(o => o.Type == LimitOrderType.Buy)
        //        .Select(o => o.Price)
        //        .DefaultIfEmpty(0)
        //        .Min();

        //    decimal minLykkeAsk = lykkeLimitOrders
        //        .Where(o => o.Type == LimitOrderType.Sell)
        //        .Select(o => o.Price)
        //        .DefaultIfEmpty(0)
        //        .Min();

        //    decimal maxLykkeBid = lykkeLimitOrders
        //        .Where(o => o.Type == LimitOrderType.Buy)
        //        .Select(o => o.Price)
        //        .DefaultIfEmpty(0)
        //        .Max();

        //    decimal currentAsk = minTraderAsk > 0 ? Math.Min(minTraderAsk, minLykkeAsk) : minLykkeAsk;
        //    decimal currentBid = Math.Max(maxTraderBid, maxLykkeBid);

        //    return new SpreadViewModel
        //    {
        //        Raw = new QuoteViewModel(minLykkeAsk, maxLykkeBid),
        //        Upper = new QuoteViewModel(maxTraderAsk, minTraderBid),
        //        Lower = new QuoteViewModel(minTraderAsk, maxTraderBid),
        //        Current = new QuoteViewModel(currentAsk, currentBid)
        //    };
        //}

        //public static VolumeViewModel GetVolumeDetails(IReadOnlyList<LimitOrderModel> traderLimitOrders)
        //{
        //    return new VolumeViewModel
        //    {
        //        Sell = traderLimitOrders
        //            .Where(o => o.Type == LimitOrderType.Sell)
        //            .Select(o => o.Volume)
        //            .DefaultIfEmpty(0)
        //            .Sum(),
        //        Buy = traderLimitOrders
        //            .Where(o => o.Type == LimitOrderType.Buy)
        //            .Select(o => o.Volume)
        //            .DefaultIfEmpty(0)
        //            .Sum(),
        //        Total = traderLimitOrders
        //            .Select(o => o.Volume)
        //            .DefaultIfEmpty(0)
        //            .Sum()
        //    };
        ...
        //public static List<LimitOrderViewModel> GetLimitOrders(IReadOnlyList<LimitOrderModel> traderLimitOrders, IReadOnlyList<LimitOrderModel> lykkeLimitOrders)
        //{
        //    if (traderLimitOrders.Count == 0)
        //        return new List<LimitOrderViewModel>();

        //    LimitOrderModel bestSellLykkeLimitOrder = lykkeLimitOrders
        //        .OrderBy(o => o.Price)
        //        .FirstOrDefault(o => o.Type == LimitOrderType.Sell);

        //    LimitOrderModel bestBuyLykkeLimitOrder = lykkeLimitOrders
        //        .OrderByDescending(o => o.Price)
        //        .FirstOrDefault(o => o.Type == LimitOrderType.Buy);

        //    List<LimitOrderViewModel> limitOrders = traderLimitOrders
        //        .Select(o => new LimitOrderViewModel
        //        {
        //            IsSell = o.Type == LimitOrderType.Sell,
        //            Price = o.Price,
        //            Volume = o.Volume,
        //            Error = GetLimitOrderError(o)
        //        })
        //        .OrderByDescending(o => o.Price)
        //        .ToList();

        //    if (bestSellLykkeLimitOrder != null)
        //    {
        //        limitOrders.Add(new LimitOrderViewModel
        //        {
        //            IsSell = true,
        //            Price = bestSellLykkeLimitOrder.Price,
        //            Volume = bestSellLykkeLimitOrder.Volume,
        //            IsClient = true
        //        });
        //    }

        //    if (bestBuyLykkeLimitOrder != null)
        //    {
        //        limitOrders.Add(new LimitOrderViewModel
        //        {
        //            IsSell = false,
        //            Price = bestBuyLykkeLimitOrder.Price,
        //            Volume = bestBuyLykkeLimitOrder.Volume,
        //            IsClient = true
        //        });
        //    }
        ...
        //public static List<LimitOrderViewModel> GetLimitOrders(IReadOnlyList<LimitOrderModel> limitOrders, int depth)
        //{
        //    IEnumerable<LimitOrderModel> lykkeSellLimitOrders = limitOrders
        //        .Where(o => o.Type == LimitOrderType.Sell)
        //        .OrderBy(o => o.Price)
        //        .Take(depth);

        //    IEnumerable<LimitOrderModel> lykkeBuyLimitOrders = limitOrders
        //        .Where(o => o.Type == LimitOrderType.Buy)
        //        .OrderByDescending(o => o.Price)
        //        .Take(depth);

        //    var result = new List<LimitOrderModel>();
        //    result.AddRange(lykkeSellLimitOrders);
        //    result.AddRange(lykkeBuyLimitOrders);
        ...
        //public static string GetLimitOrderError(LimitOrderModel limitOrder)
        //{
        //    switch (limitOrder.Error)
        //    {
        //        case LimitOrderError.Arbitrage:
        //            return "Arbitrage is possible";
        //        case LimitOrderError.EmptyOrderBook:
        //            return "Empty order book";
        //        case LimitOrderError.NotEnoughFunds:
        //            return "Not enough funds";
        //        case LimitOrderError.Unknown:
        //            return limitOrder.ErrorMessage;
        //        case LimitOrderError.None:
        //            return null;
        //        default:
