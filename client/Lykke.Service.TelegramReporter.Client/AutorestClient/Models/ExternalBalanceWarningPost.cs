...
namespace Lykke.Service.TelegramReporter.Client.AutorestClient.Models
{
    ...
    public partial class ExternalBalanceWarningPost
    {
        /// <summary>
        /// Initializes a new instance of the ExternalBalanceWarningPost class.
        /// </summary>
        public ExternalBalanceWarningPost()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the ExternalBalanceWarningPost class.
        /// </summary>
        public ExternalBalanceWarningPost(string exchange, string assetId, string name, string assetName, double minBalance)
        {
            Exchange = exchange;
            AssetId = assetId;
            Name = name;
